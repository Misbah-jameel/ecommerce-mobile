  ...
  return (
    <div className="max-w-[1200px] mx-auto p-4">
      ...
      <div className="flex justify-between items-center  mb-6">
        <h2 className="text-4xl font-bold text-center w-full">Explore Our Product</h2>
        <button className="bg-[#db4444] text-white px-6 justify-start py-2 rounded-md font-bold hover:bg-[#c33b3b]">
          Our Product
        </button>
      </div>
